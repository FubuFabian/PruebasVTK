...
void QVTKImageWidget::setAndDisplayVolume(QString volumeFilename)
{
	...
	volumeScalarOpacity->AddPoint(127,1.0);
	volumeScalarOpacity->AddPoint(255,0.0);
    volumeScalarOpacity->Update();
    volumeProperty->SetScalarOpacity(volumeScalarOpacity);

    vtkSmartPointer<vtkColorTransferFunction> volumeColor = vtkSmartPointer<vtkColorTransferFunction>::New();
    volumeColor->AddRGBSegment(50,0.0,0.0,0.0,255,1.0,1.0,1.0);
...
void QVTKImageWidget::setAndDisplayVolume(vtkSmartPointer<vtkImageData> volumeData)
{
    ...
    volumeScalarOpacity = vtkSmartPointer<vtkPiecewiseFunction>::New();
	volumeScalarOpacity->AddSegment(0,0.0,128,1.0);
	volumeScalarOpacity->AddSegment(128,1.0,255,0.00);
    volumeScalarOpacity->Update();
    volumeProperty->SetScalarOpacity(volumeScalarOpacity);

    volumeColor = vtkSmartPointer<vtkColorTransferFunction>::New();
    volumeColor->AddRGBSegment(0,0.0,0.0,0.0,255,1.0,1.0,1.0);
    volumeProperty->SetColor(volumeColor);
	...
	ChangeVolumePropertiesWidget *volumePropertiesChanger = new ChangeVolumePropertiesWidget();
	volumePropertiesChanger->setQVTKImageWidget(this);
	volumePropertiesChanger->show();
...
void QVTKImageWidget::setVolumeOpacity(vtkSmartPointer<vtkPiecewiseFunction> opacity)
{
	...
	volumeScalarOpacity = opacity;
	volumeProperty->SetScalarOpacity(volumeScalarOpacity);
	renwin->Render();
}

void QVTKImageWidget::setVolumeColor(vtkSmartPointer<vtkColorTransferFunction> color)
{
